...
$head = [
    'title' => 'Đăng Nhập' . ' | ' . $HN->setting('title'),
                    ...
                    <div class="user-form-group">
                        <form class="user-form">
                            ...
                            <div class="form-button">
                                ...
                                <p><a href="<?= client_url("forgot-password") ?>">Quên mật khẩu ?</a></p>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $("#btnLogin").on("click", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                } else if (response.status == 'ban_ip') {
                    location.href = '<?= base_url('common/block-ip.php'); ?>';
                } else if (response.status == 'ban') {
                    location.href = '<?= base_url('common/banned.php'); ?>';
                } else {
                    new Notify({
                        status: 'error',
                        title: 'Thất bại',
