...
<head>
    ...
    <title>Block Ip <?= get_ip() ?></title>
    <link rel="stylesheet" href="<?= base_url("public/banned/style.css") ?>">
</head>
...
<body>
    ...
    <h3><?= __("IP " . get_ip() . " CỦA BẠN BỊ CẤM TRUY CẬP !") ?></h3>
    <p>Vui lòng liên hệ <a href="https://zalo.me/<?= $HN->setting('zalo'); ?>" target="_blank">ADMIN</a> để giải quyết !
    </p>
</body>
