...
<!-- Loader -->
<div id="loader">
    <img src="<?= base_url("assets/img/storage/loader.svg") ?>" alt="">
</div>
<!-- Loader -->
<div class="page">
    <!-- app-header -->
        ...
        <div class="main-header-container container-fluid">
            ...
            <div class="header-content-left">
                ...
                <div class="header-element">
                    <div class="horizontal-logo">
                        <a href="<?= base_url("?module=admin&action=") ?>" class=" header-logo">
            ...
            <div class="header-content-right">
                ...
                <div class="header-element header-fullscreen">
                    <!-- Start::header-link -->
                    <a onclick="openFullscreen();" href="javascript:void(0);" class="header-link"> <i
                            class="bx bx-fullscreen full-screen-open header-link-icon d-block"></i> <i
